...
public enum ExceptionEnum {
    ...
    WRONG_USERNAME_OR_PASSWORD_EXCEPTION("Wrong username or password", LocalDateTime.now()), YOU_HAVE_NOT_ORDER_EXCEPTION("You have not order", LocalDateTime.now()), IRREVOCABLE_EXCEPTION("Irrevocable", LocalDateTime.now()), FLIGHTS_NOT_FOUND_EXCEPTION("Flight not found", LocalDateTime.now()), PASSENGER_NOT_FOUND("Passenger not found", LocalDateTime.now()), TICKETS_NOT_FOUND("Ticket not found", LocalDateTime.now());
